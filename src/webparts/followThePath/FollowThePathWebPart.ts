...
import FollowThePath from './components/FollowThePath';
import { IFollowThePathProps } from './components/IFollowThePathProps';
...
export default class FollowThePathWebPart extends BaseClientSideWebPart<IFollowThePathWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IFollowThePathProps> = React.createElement(
      FollowThePath,
      {
